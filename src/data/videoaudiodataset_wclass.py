...
class VideoAudioDataset_wClass(Dataset):
    def __init__(self, ids_file,
        ...
        self.items = items
        self.vid2class = json.load(open(vid2class_file, 'r'))
    ...
    def __getitem__(self, idx):
        ...
        class_id = self.vid2class[cid]['class_id']
        class_name = self.vid2class[cid]['class_name']
        ...
        try:
            ...
            print(f"Fail to load video {cid}")
...
class Video_Manager(object):
    def __init__(self, video_root, video_fps, img_size, flip_p=0.5,
                 num_tar_frames=2, full_video_length=16, content_frame_idx=(0, 5, 10, 15)):
