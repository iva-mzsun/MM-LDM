...
class StableAutoencoder(DDPM):
    ...
    def decode(self, latents, uc_latents, n_frames=4, verbose=False):
        ...
        c_audio = repeat(self.context_emb, 'l c -> b l c',
        ...
        c_video = repeat(self.context_emb, 'l c -> b l c',
        ...
        cond = dict(audio=cond_audio, video=cond_video)
        uc_cond = dict(audio=ucond_audio, video=ucond_video)
